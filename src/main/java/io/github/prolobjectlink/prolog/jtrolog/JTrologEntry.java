 ...
 * @since 1.1
 */
public final class JTrologEntry extends AbstractCompounds implements PrologEntry {

	private final PrologTerm key;
	private PrologTerm value;

	JTrologEntry(PrologProvider provider, PrologTerm key, PrologTerm value) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JTrologEntry other = (JTrologEntry) obj;
		if (key == null) {
			if (other.key != null)
				return false;
