...
import io.github.prolobjectlink.prolog.jtrolog.JTrologIndicator;
import io.github.prolobjectlink.prolog.jtrolog.JTrologOperator;
...
public class PrologEngineTest extends PrologBaseTest {
	...
	public final void testCurrentPredicates() {
		...
		Iterator<?> libraries = prolog.getCurrentLibraries();
	...
	public final void testCurrentOperators() {
		...
		Iterator<?> i = new Prolog().getCurrentOperators();
		while (i.hasNext()) {
	...
	public final void testGetLicense() {
		assertEquals(Licenses.NO_SPECIFIED, engine.getLicense());
	}

	@Test
	public final void testGetVersion() {
		assertEquals(Prolog.VERSION, engine.getVersion());
	}

	@Test
	public final void testGetName() {
		assertEquals("jTrolog", engine.getName());
	}
