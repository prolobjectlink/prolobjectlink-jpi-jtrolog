...
public class PrologProviderTest extends PrologBaseTest {
	...
	public final void testParseTerm() {
		...
		//
		PrologTerm employeeStructure = provider.parseTerm("employee(Name,Dpto,Scale)");
	...
	public final void testToString() {
		...
		assertEquals(JTrolog.class.getSimpleName() + " [converter=" + JTrologConverter.class.getSimpleName() + "]",
				provider.toString());
